...
def define_input(define_io, define_fit, define_output, define_plots, define_intpol):
    ...
    xmlfilename = "gaia_spec_gsp_lm.xml"
    ...
    define_io["outputpath"] = os.path.join(BASTADIR, "Paper1/output/gaia_spec_gsp_lm")
    ...
    define_io["asciifile"] = (os.path.join(BASTADIR, "Paper1/data/") + "gsp_spec_lm.ascii")


    define_io["params"] = ("starid",
        "RA",
        "DEC",
        "Teff",
        "Teff_err",
    ...
    # individual star!
    #define_io["overwriteparams"] = {"Mb_JC": (7, 2)}
    ...
    #     The full list is available in REMEMB=ER TO ADD LINK !
    define_fit["fitparams"] = ("Teff","MeH")
