...
def define_input(define_io, define_fit, define_output, define_plots, define_intpol):
    ...
    define_io["outputpath"] = os.path.join(BASTADIR, "Paper1/output/nasa")
    ...
    define_io["asciifile"] = (os.path.join(BASTADIR, "Paper1/data/") + "basta_input_nasa.ascii")
    ...
    define_fit["fitparams"] = ("Teff","FeH","parallax")
