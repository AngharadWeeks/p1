...
def define_input(define_io, define_fit, define_output, define_plots, define_intpol):
    ...
    define_io["outputpath"] = os.path.join(BASTADIR, "Paper1/output/gaia_spec_gsp")
    ...
    define_io["asciifile"] = (os.path.join(BASTADIR, "Paper1/data/") + "basta_input_gaia_spec_gsp.ascii")
    ...
    define_fit["fitparams"] = ("Teff","MeH","parallax")
    ...
    define_fit["filters"] = ("Mk_2MASS", "Mj_2MASS", "Mh_2MASS")
