...
def define_input(define_io, define_fit, define_output, define_plots, define_intpol):
    ...
    xmlfilename = "gaia_spec_gsp_age0.xml"
    ...
    define_io["outputpath"] = os.path.join(BASTADIR, "Paper1/output/gaia_spec_gsp_age0")
    ...
    define_io["asciifile"] = (os.path.join(BASTADIR, "Paper1/data/") + "gsp_spec_age0.ascii")
